...
// Constants
const TOP_CARD_STYLES = 'flex flex-1 w-full h-full min-h-[16rem] rounded-lg relative overflow-hidden'; // For Skeleton 1, 2, 3
const BOTTOM_CARD_STYLES = 'flex flex-1 w-full h-full min-h-[26rem] rounded-lg relative overflow-hidden'; // For Skeleton 4
const SKELETON_FIVE_STYLES = 'flex flex-1 w-full h-full min-h-[26rem] rounded-lg relative overflow-hidden'; // For Skeleton 5
...
const BentoGridItem = memo<BentoGridItemProps>(({ title, description, header, className, link, onClick }) => (
  <motion.div
    className={cn(
